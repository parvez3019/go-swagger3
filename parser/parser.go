...
func NewParser(modulePath, mainFilePath, handlerPath string, debug, strict, schemaWithoutPkg bool, requiredByDefault bool) *parser {
	return &parser{
		Utils: model.Utils{
			Path:        getPaths(modulePath, mainFilePath, handlerPath),
			Flags:       geFlags(debug, strict, schemaWithoutPkg, requiredByDefault),
...
func geFlags(debug bool, strict bool, schemaWithoutPkg bool, requiredByDefault bool) model.Flags {
	return model.Flags{
